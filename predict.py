...
class Inference():
    ...
    def __init__(self, config_file='config.cfg', model='hg_refined_tiny_200'):
        ...
        self.predict.save_multioutput_as_mat(datagen1=datatest1, datagen2=datatest2,datagen3=datatest3,datagen4=datatest4,idlh=2,idrs=15)
